...
import { CardDef, CardInstance } from '../../Card/CardBase/CardInstance';
import { BP_CardMovementComponent } from '../UIComponent/BP_CardMovementComponent';
...
export class DuelPage extends PanelInstance {
    ...
    protected _path = BlueprintPath.BPW_DuelPage
