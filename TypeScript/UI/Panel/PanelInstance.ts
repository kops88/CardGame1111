...
import { TemplateAbility } from '../UIAbility/TemplateAbility';
...
export abstract class PanelInstance { 
    ...
    protected abstract _panel: UE.UserWidget;
    ...
    /** 用于管理Template组件 */
    protected TemplateUtils: TemplateAbility;

    constructor(id: number) {
        this._id = id;
        this.TemplateUtils = new TemplateAbility(this);
    }
     ...
     */
    private Load(visible: boolean = true) {
