...
import { PaneNameEnum, PanelNameType, PanelModule } from "../path/PanelPath";
...
export class PanelSystem {
    ...
    AddPanelByName(panelName: string) { 
        ...
        // 不存在 panel 创建， 添加 返回
        const name = PaneNameEnum[panelName];
        const panelClass = require(PanelModule[name])?.default;
    ...
    // LoadPanelByName(name: PanelNameType) {
